...
// console.log( Categories.map((category) => ({value:category, label:category.split("-").join(" ") , checked:false})))

 const   brands = [...new Set([...products.map((product) => product.brand)])];

console.log( brands.map((brand) => ({value:brand, label:brand.split("-").join(" ") , checked:false})))
